 ...
 * </p>
 * <ul>
 * <li>FlowException - 流量控制异常</li>
 * <li>DegradeException - 熔断降级异常</li>
 * <li>ParamFlowException - 热点参数限流异常</li>
 * <li>AuthorityException - 授权异常</li>
 * </ul>
 *
 * @author seckill
 * @since 3.0.0
...
public class SentinelExceptionHandler {
    ...
    public Result<Void> handleParamFlowException(ParamFlowException e) {
        ...
        return Result.error(ResultCode.RATE_LIMIT.getCode(), "该资源访问过于频繁，请稍后重试");
    }
    ...
    /**
     * 处理所有 BlockException（兜底）
     */
    @ExceptionHandler(BlockException.class)
    public Result<Void> handleBlockException(BlockException e) {
        log.warn("触发 Sentinel 规则 - rule: {}, type: {}", e.getRule(), e.getClass().getSimpleName());
