 ...
 * @returns 订单号
 */
export function doSeckill(data: SeckillRequest): Promise<ApiResponse<number>> {
 ...
 * 检查用户是否已秒杀该商品
 */
export function checkKilled(userId: number, goodsId: number): Promise<ApiResponse<boolean>> {
